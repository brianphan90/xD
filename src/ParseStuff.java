...
public class ParseStuff {
                                     ...
                                     ImageStore imageStore)
    {
        if (properties.length == MINER_NUM_PROPERTIES)
        {
            ...
            AbstractEntity entity = CreateStuff.createMinerNotFull(properties[MINER_ID],
                                        ...
                                        ImageStore imageStore)
    {
        if (properties.length == OBSTACLE_NUM_PROPERTIES)
        {
            ...
            AbstractEntity entity = CreateStuff.createObstacle(properties[OBSTACLE_ID],
                                   ...
                                   ImageStore imageStore)
    {
        if (properties.length == ORE_NUM_PROPERTIES)
        {
            ...
            AbstractEntity entity = CreateStuff.createOre(properties[ORE_ID],
                                     ...
                                     ImageStore imageStore)
    {
        if (properties.length == SMITH_NUM_PROPERTIES)
        {
            ...
            AbstractEntity entity = CreateStuff.createBlacksmith(properties[SMITH_ID],
                                    ...
                                    ImageStore imageStore)
    {
        if (properties.length == VEIN_NUM_PROPERTIES)
        {
            ...
            AbstractEntity entity = CreateStuff.createVein(properties[VEIN_ID],
                    pt,
    ...
    public static void loadImages(Scanner in, ImageStore imageStore,
                                  PApplet screen)   //world loader class w/ things it calls
    {
        int lineNumber = 0;
