...
public void setup()
{
                                  ...
                                  PApplet screen)
   {
      try
      {
         ...
         ParseStuff.loadImages(in, imageStore, screen);
      }
                                ...
                                ImageStore imageStore)
   {
      ...
      {
         Scanner in = new Scanner(new File(filename));
         ParseStuff.load(in, world, imageStore);
      }
      catch (FileNotFoundException e)
      {
         System.err.println(e.getMessage());
   ...
   public static void scheduleActions(WorldModel world,
      ...
      for (AbstractEntity entity : world.entities) {
         if (entity instanceof AbstractActive) {
            ((AbstractActive) entity).scheduleActions(scheduler, world, imageStore);
         }
      }
   }
